...
**
**     Abstract:
**         This header file implements peripheral memory map for MKL04Z4
**         processor.
**
 ...
 * @version 1.6
 * @date 2015-02-19
 * @brief Peripheral memory map for MKL04Z4
 *
 * This header file implements peripheral memory map for MKL04Z4 processor.
 */
...
#if !defined(MCU_MKL04Z4)  /* Check if memory map has not been already included */
#define MCU_MKL04Z4
