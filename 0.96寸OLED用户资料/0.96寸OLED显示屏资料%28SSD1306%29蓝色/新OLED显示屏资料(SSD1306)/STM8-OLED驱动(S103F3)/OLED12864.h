...
#define LCD_CLK   PC_ODR_ODR4//OLED时钟
#define LCD_MOSI  PC_ODR_ODR3 //OLED数据
#define LCD_CS    PC_ODR_ODR6 //OLED片选
#define LCD_DC    PC_ODR_ODR5  //OLED命令/数据切换
#define XLevelL		0x00
#define XLevelH		0x10
